...
def clean(text):
    text = text.lower()
    #text = expand_contractions(text)  # TODO: Why not do this?
    text = clean_whitespace(text)
    return text

def clean_db(text): # FIXME: two redundant clean functions, remove and work with one for all solution
    text = text.lower()
